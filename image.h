...
// Marche nickel
/** Reconstruit un pixel de coordonnee (x,y) � partir d'une Matrice de moment de Legendre
  * @param x coordonnee en abscisse
  * @param y coordonnee en ordonnee
  * @param mat Matrice de moment de Legendre
  * @param Matrice coef : coefficients du polynome de legendre � passer � la fonction baseLegendre
...
// Marche nickel
/** Reconstruit une image de coordonnee (x,y) � partir d'une Matrice de moment de Legendre et d'une image bmp
  * @param *pic image que l'on va reconstruire
  * @param mat Matrice de moment de Legendre
  * @param Matrice coef : coefficients du polynome de legendre � passer � la fonction reconstruction pixel
  */
